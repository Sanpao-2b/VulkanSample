...
public:
	...
	*/
	void loadTexture()
	{
		...
		ktx_uint8_t *ktxTextureData = ktxTexture_GetData(ktxTexture);	// ʵ�ʵ�ͼ�����ݺͳߴ�
	...
	void updateUniformBuffers()
	{
		...
		memcpy(uniformBufferVS.mapped, &uboVS, sizeof(uboVS));	// ��mapped�ڴ�д������, ��ͬ����GPU buffer��ȥ
	}
