...
void VulkanExampleBase::updateOverlay()
{
	...
	// ��ȡ ImGui �� IO ���󣬺�����ʹ������������������λ�á�����״̬����Ϣ��
	ImGuiIO& io = ImGui::GetIO();

	io.DisplaySize = ImVec2((float)width, (float)height);
	io.DeltaTime = frameTimer;

	// �����λ�á���������м���״̬���ݸ� ImGui �� IO �������ڸ��� Overlay ���档
